      ...
      <View>
        ...
        <Button
          ...
          if  (sendTextResponse.status!=200){
            console.log("sever send text respoonse: "+sendTextResponse.status)
            Alter('communication Error', 'Server responded to send text with status: '+sendTextResponse.status);
          }
          }}
        />
<TextInput
